...
Ключи хранятся в таблице `api_keys` и управляются через админ-панель: добавление, сброс дневного лимита, удаление. В переменных окружения ключи не хранятся, API отдаёт их в маскированном виде.
