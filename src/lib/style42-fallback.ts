...
export function buildFallbackPrompt(
	userInput: string,
	anchors: Anchors,
	options: { textRequested?: boolean; exactTexts?: string[] } = {},
): string {
	...
	return [
		...
		`Luxury overload: ${anchors.luxury}, ${anchors.props}, gold chains, leopard fur, crowns, gold bars and diamond sparkle on every surface.`,
		`${anchors.lighting}.`,
